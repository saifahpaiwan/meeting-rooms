...
(function ($) {
    ...
    var methods = {
        ...
        step: function (index) {
            ...
            that[0].heads
                .removeClass("stepy-active")
                .eq(max)
                .addClass("stepy-active");
