        ...
        e = (function () {
            ...
            return (
                b.mixin(c.prototype, {
                    set: function (b, c) {
                        ...
                        this.size >= this.maxSize &&
                            ...
                            this.size--),
                            (f = this.hash[b])
                                ? ((f.val = c), this.list.moveToFront(f))
                                : ((f = new e(b, c)),
                                  this.list.add(f),
                                  (this.hash[b] = f),
                                  this.size++);
                ...
                b.mixin(d.prototype, {
                    add: function (b) {
                        this.head &&
                            ((b.next = this.head), (this.head.prev = b)),
                            (this.head = b),
        ...
        f = (function () {
            ...
            function h(a) {
                var b,
                    ...
                    f = c.length;
                for (b = 0; b < f; b++)
                    (d = c.key(b)).match(a) && e.push(d.replace(a, ""));
                return e;
            }
            var c;
            try {
                ...
                b.mixin(d.prototype, {
                    ...
                    get: function (a) {
                        return (
                            ...
                            g(this.ls.getItem(this._prefix(a)))
                        );
                    },
                    set: function (a, c, d) {
                        return (
                            b.isNumber(d)
                                ? this._safeSet(this._ttlKey(a), f(e() + d))
                                : this.ls.removeItem(this._ttlKey(a)),
                            this._safeSet(this._prefix(a), f(c))
                        );
                    },
                    remove: function (a) {
                        return (
                    ...
                    _get: function (a, b) {
                        ...
                        function j() {
                            c--,
                                delete d[f],
                                e.onDeckRequestArgs &&
                                    (e._get.apply(e, e.onDeckRequestArgs),
                        ...
                        return (
                            ...
                            b.each(j, function (a) {
                                ...
                                for (
                                    ...
                                    b = b[c][f];
                                if (b && 0 === e.length)
                                    (h = b[d].slice(0)), (k = k ? i(k, h) : h);
                                else if (!g.matchAnyQueryToken)
                                    return (k = []), !1;
                            }),
                            k
        ...
        i = (function () {
            ...
            return (
                ...
                b.mixin(c.prototype, {
                    ...
                    store: function (c) {
                        this.cache &&
                            (this.storage.set(a.data, c, this.ttl),
                            this.storage.set(
                                a.protocol,
                                location.protocol,
                                this.ttl
                    ...
                    fromNetwork: function (a) {
                        ...
                        var c,
                            b = this;
                        a &&
                            ((c = this.prepare(this._settings())),
                            this.transport(c).fail(d).done(e));
                    },
                    clear: function () {
                ...
                b.mixin(a.prototype, {
                    ...
                    get: function (b, c) {
                        ...
                        if (c)
                            return (
                                (b = b || ""),
                                (e = this.prepare(b, this._settings())),
                                this.transport.get(e, f)
                            );
                    },
        ...
        return (
            ...
            b.mixin(e.prototype, {
                    ...
                    return (
                        ...
                        this.prefetch
                            ? (e = this.prefetch.fromCache())
                                ? (this.index.bootstrap(e), d.resolve())
                                : this.prefetch.fromNetwork(f)
                            : d.resolve(),
                        d.promise()
                    );
                },
                _initialize: function () {
                    ...
                    return (
                        this.clear(),
                        (this.initPromise = this._loadPrefetch()).done(d),
                        this.initPromise
                    );
                },
                initialize: function (b) {
                    return !this.initPromise || b
                        ? this._initialize()
                        : this.initPromise;
                },
                add: function (b) {
                ...
                get: function (c) {
                    return (
                        (c = b.isArray(c) ? c : [].slice.call(arguments)),
                        this.index.get(c)
                    );
                },
                search: function (c, d, e) {
                    ...
                    return (
                        ...
                        this.remote && g.length < this.sufficient
                            ? this.remote.get(c, h)
        ...
        var b = (function () {
            ...
            c = (function () {
                ...
                function d(a) {
                    return {
                        ...
                        menu:
                            '<div role="listbox" class="' + a.menu + '"></div>',
                    };
                }
                function e(a) {
                    var c = {};
                ...
                return (
                    ...
                    b.mixin(e.prototype, {
                        _trigger: function (b, d) {
                            var e = a.Event(c + b);
                            return (
                                this.$el.trigger.call(this.$el, e, d || []), e
                            );
                        },
                        before: function (a) {
                            var b, c;
            ...
            e = (function () {
                ...
                function g(c) {
                    ...
                    if (!this._callbacks) return this;
                    for (
                        c = c.split(a), f = [].slice.call(arguments, 1);
                        (d = c.shift()) && (e = this._callbacks[d]);
                ...
                return (
                    ...
                    b.mixin(d.prototype, e, {
                        ...
                        _onKeydown: function (b) {
                            ...
                            this._managePreventDefault(d, b),
                                d &&
                                    this._shouldTrigger(d, b) &&
                                    this.trigger(d + "Keyed", b);
                        },
                        _onInput: function () {
                        ...
                        _checkLanguageDirection: function () {
                            ...
                            this.dir !== b &&
                                ((this.dir = b),
                                this.$hint.attr("dir", b),
                                this.trigger("langDirChanged", b));
                        },
                        _setQuery: function (b, c) {
                            var d, e;
                            (d = g(b, this.query)),
                                (e = !!d && this.query.length !== b.length),
                                (this.query = b),
                                c || d
                                    ? !c &&
                                      e &&
                        ...
                        clearHintIfInvalid: function () {
                            var b, c, d, e;
                            (b = this.getInputValue()),
                                (c = this.getHint()),
                                (d = b !== c && 0 === c.indexOf(b)),
                                !(e = "" !== b && d && !this.hasOverflow()) &&
                                    this.clearHint();
                        },
                        hasFocus: function () {
            ...
            h = (function () {
                ...
                return (
                    ...
                    (g.extractData = function (d) {
                        ...
                        return e.data(c.obj)
                            ? {
                                  dataset: e.data(c.dataset) || "",
                                  val: e.data(c.val) || "",
                                  obj: e.data(c.obj) || null,
                              }
                            : null;
                    }),
                    b.mixin(g.prototype, e, {
                        ...
                        _renderSuggestions: function (b, c) {
                            var d;
                            (d = this._getSuggestionsFragment(b, c)),
                                (this.$lastSuggestion = d.children().last()),
                                this.$el
                                    .html(d)
                                ...
                                b.each(g, function (d) {
                                    ...
                                    (g = h._injectQuery(e, d)),
                                        (f = a(h.templates.suggestion(g))
                                            ...
                                            .addClass(
                                                h.classes.suggestion +
                                                    " " +
                                                    h.classes.selectable
                                            )),
                                        i.appendChild(f[0]);
                                }),
                                this.highlight &&
                        ...
                        update: function (c) {
                            function h(a) {
                                f ||
                                    ...
                                    g < d.limit &&
                                        d.async &&
                                        d.trigger("asyncRequested", c, d.name));
                            }
                            function i(b) {
                                if (((b = b || []), !e && g < d.limit)) {
                                    d.cancel = a.noop;
            ...
            i = (function () {
                ...
                function c(c, d) {
                    ...
                    (c = c || {}),
                        ...
                        (this.$node = a(c.node)),
                        (this.query = null),
                        (this.datasets = b.map(c.datasets, f));
                }
                return (
                    b.mixin(c.prototype, e, {
                        ...
                        _onRendered: function (b, c, d, e) {
                            this.$node.toggleClass(
                                ...
                                this.trigger("datasetRendered", c, d, e);
                        },
                        _onCleared: function () {
                            this.$node.toggleClass(
                                this.classes.empty,
                        ...
                        _allDatasetsEmpty: function () {
                            return b.every(
                                ...
                                b.bind(function (b) {
                                    var c = b.isEmpty();
                                    return (
                                        this.$node.attr("aria-expanded", !c), c
                                    );
                                }, this)
                            );
                        },
                        ...
                        _ensureVisible: function (b) {
                            ...
                            (c = b.position().top),
                                ...
                                c < 0
                                    ? this.$node.scrollTop(e + c)
                                    : f < d &&
                                      this.$node.scrollTop(e + (d - f));
                        },
                        bind: function () {
                            var d,
                                c = this;
                        ...
                        selectableRelativeToCursor: function (b) {
                            var c, d, e, f;
                            return (
                                (d = this.getActiveSelectable()),
                                (c = this._getSelectables()),
                                (e = d ? c.index(d) : -1),
                                (f = e + b),
                                (f = ((f + 1) % (c.length + 1)) - 1),
                                (f = f < -1 ? c.length - 1 : f),
                        ...
                        setCursor: function (b) {
                            this._removeCursor(),
                                (b = b && b.first()) &&
                                    (b.addClass(this.classes.cursor),
                    ...
                    b.mixin(c.prototype, i.prototype, {
                        open: function () {
                            return (
                                ...
                                a.open.apply(this, [].slice.call(arguments, 0))
                            );
                        },
                        close: function () {
                            return (
                                this._hide(),
                                a.close.apply(this, [].slice.call(arguments, 0))
                            );
                        },
                        ...
                        setLanguageDirection: function (c) {
                            return (
                                this.$node.css(
                                    "ltr" === c ? this.css.ltr : this.css.rtl
                                ),
                                a.setLanguageDirection.apply(
                                    this,
                                    [].slice.call(arguments, 0)
                                )
                            );
                ...
                return (
                    b.mixin(c.prototype, {
                        ...
                        _onDatasetRendered: function (b, c, d, e) {
                            this._updateHint(),
                                this.eventBus.trigger("render", c, d, e);
                        },
                        ...
                        _onEnterKeyed: function (b, c) {
                            var d;
                            (d = this.menu.getActiveSelectable()) &&
                                this.select(d) &&
                        ...
                        _onTabKeyed: function (b, c) {
                            var d;
                            (d = this.menu.getActiveSelectable())
                                ? this.select(d) && c.preventDefault()
                                : (d = this.menu.getTopSelectable()) &&
                                  this.autocomplete(d) &&
                                  c.preventDefault();
                        },
                        ...
                        _updateHint: function () {
                            ...
                            (c = this.menu.getTopSelectable()),
                                ...
                                this.input.hasOverflow()
                                    ...
                                    : ((f = g.normalizeQuery(e)),
                                      (h = b.escapeRegExChars(f)),
                                      (i = new RegExp(
                                          "^(?:" + h + ")(.+$)",
                                          "i"
                                      )),
                                      (j = i.exec(d.val)) &&
                                          this.input.setHint(e + j[1]));
                        },
                        isEnabled: function () {
                            return this.enabled;
                        },
                        ...
                        moveCursor: function (b) {
                            ...
                            return (
                                ...
                                !(
                                    ...
                                    (this.menu.setCursor(d),
                                    e
                                        ? this.input.setInputValue(e.val)
                                        : (this.input.resetInputValue(),
                                          this._updateHint()),
                                    this.eventBus.trigger("cursorchange", f, g),
                                    !0)
                            );
                        },
                        destroy: function () {
        ...
        !(function () {
            ...
            (e = a.fn.typeahead),
                        ...
                        function q() {
                            ...
                            b.each(m, function (a) {
                                ...
                                (t || u) &&
                                    (e.css(p.css.wrapper),
                                    c.css(
                                        t ? p.css.input : p.css.inputWithNoHint
                                    ),
                                    c
                                        .wrap(e)
                                        .parent()
                ...
                (a.fn.typeahead = function (a) {
                    return h[a]
                        ? h[a].apply(this, [].slice.call(arguments, 1))
