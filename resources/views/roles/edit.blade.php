        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">แก้ไขรายการสิทธิ์ผู้ใช้งาน</li>
                </ol>
            </div>
            <h4 class="page-title"> แก้ไขรายการสิทธิ์ผู้ใช้งาน </h4>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">แก้ไขรายการสิทธิ์ผู้ใช้งาน</h4>
                <p class="sub-header">
                                        ...
                                        <div id="collapse{{ $n }}" class="collapse show" aria-labelledby="heading{{ $n }}" data-parent="#accordion">
                                            ...
                                            <div class="checkbox col-md-12 ml-1 mb-2">
                                                ...
                                                <div class="col-md-4 checkbox checkbox-primary"> 
                                                    {{ Form::checkbox('permission[]', $row_2['id'], in_array($row_2['id'], $rolePermissions) ? true : false, array('class' => 'checkbox-'.$n, 'id' => $row_2['id'])) }}
