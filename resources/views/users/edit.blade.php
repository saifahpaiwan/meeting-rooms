...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">แก้ไขข้อมูลผู้ใช้งานระบบ</h4>
                <p class="sub-header">
                    ข้อมูลประจำวันที่ {{ date('d M Y') }}
                </p>
 
                {!! Form::model($data, ['id' => 'demo-1', 'method' => 'PATCH','route' => ['users.update', $data->id], 'enctype' => 'multipart/form-data' ]) !!}
                ...
                <div class="row"> 
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            @if(!empty($data->images_name))
                            <div class="mt-2 img-file-upload-1">
                                <div class="box-image-no" style="background: url(<?php echo asset('/images/users').'/'.$data->images_name; ?>); background-size: cover; background-position: center; border-radius: 50%; width: 100px; height: 100px;"> </div>
                            </div>
                            @else
                            <div class="mt-2 img-file-upload-1">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <hr>
                        <button type="button" class="btn btn-dark waves-effect waves-light" onClick="back()">
